  ...
  return (
    <>
      ...
      <div
        ...
        className={`${
          isHovered && "hover:bg-base-200/20 hover:-translate-y-2"
        } p-4 ring-1 flex flex-col ring-base-content/50 bg-base-200/10 text-base-content/60 transition-all duration-150 ease-in-out`}
      >
